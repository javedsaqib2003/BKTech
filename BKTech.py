...
\n\033[0m----------------------------------
\033[1;92mAuthor \033[1;93m: BKTech
\033[1;92mFb \033[1;93m: Your FB I'D
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://youtu.be/7ey46VSA')
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
